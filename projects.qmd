...
#### PhD: Creating Computer models of CaMKII/NMDAR dynamics in 3D (Oct 2020 - Nov 2025) {- #sec-phd}
- At the University of Edinburgh.
- Supervised by Melanie Stefan, David Sterratt and Nicola Romano.
- Funded by Medical Research Scotland and CERN openlab.
- You can find my thesis project repository [here](https://github.com/Susana465/camkii_thesis).

#### The Turing Way Collaborations (Ongoing)
- Participated in two Book Dashes to collaboratively write a new chapter on [Data Hazards to the Turing Way Project](https://the-turing-way.netlify.app/ethical-research/data-hazards.html). 
- Was part of the planning committee for the November 2023 Book Dash, faciliating and leading different sessions through the Book Dash week.
- I am currently part of the Book Dash Working Group, where we look at and apply long term goals and administration of Book Dashes. 
- Involved in planning and hosting Onboarding Calls for new community members to the TTW project.

#### Leading Data Hazards workshops (Ongoing)
...
#### Bias and reproducibility in a computational neurobiology PhD's journey (October 2022)
- Presented and discussed a poster on [Bias and reproducibility in my PhD](https://github.com/Susana465/Bias-and-Reproducibility-Poster) as part of COMBINE conference 2022. 

#### Climate Cafes (2021 - 2023)
- Co-led and facilitated multiple [Climate Cafes](https://www.climatepsychologyalliance.org/~cpa/events/500-climate-cafe-jan) with the Climate Psychology Alliance, from 2021 to 2023. 
